...
'Kemudian Pilih Pilihan Account Assistant'
WebUI.click(findTestObject('Directory Test Case/Page_OrangeHRM/span_Account Assistant'))

'Klik Select pada Location'
WebUI.click(findTestObject('Directory Test Case/Page_OrangeHRM/div_Location-- Select --'))

'Kemudian Pilih Pilihan Texas RD'
WebUI.click(findTestObject('Directory Test Case/Page_OrangeHRM/span_Texas RD'))

'Klik Button Search'
WebUI.click(findTestObject('Object Repository/Directory Test Case/Page_OrangeHRM/button_Search'))

'Melakukan Verifikasi Setelah Klik Button Search, Akan Menampilkan Elemen "No Records Found"'
WebUI.verifyElementVisible(findTestObject('Directory Test Case/Page_OrangeHRM/div_No Records Found'))
